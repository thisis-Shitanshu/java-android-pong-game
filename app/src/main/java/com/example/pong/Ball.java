...
class Ball {
    ...
    * */
    Ball (int screenX) {
        // Make the ball square of 1% of width of screen width
    ...
    void reset(int x, int y) {
        // Initialise the four points of the rectangle which defines ball
        mRect.left = x / 2;
        mRect.top = 0;
    ...
    void batBounce(RectF batPosition) {
        ...
        /*
        * Having calculated left or right for horizontal direction
        * simply reverse the vertical direction to go back up
        * the screen.
        * */
        reverseYVelocity();
    }
