...
class PongGame extends SurfaceView implements Runnable {
    ...
    // Hols the resolution of the screen
    ...
    public PongGame(Context context, int x, int y) {
        ...
        try {
            ...
            Log.d("error", "failedto load sound files");
        }
    ...
    public void run() {
        ...
        while (mPlaying) {
            ...
            // The movement has been handled and
            // collisions detected now we can draw the scene.
            draw();
    ...
    private void detectCollisions() {
        ...
        // Has the ball hit the edge of screen
        // Bottom
    ...
    private void draw() {
            ...
            if (mOurHolder.getSurface().isValid()) {
                ...
                // unlockCanvasAndPost is a method od SurfaceView
    ...
    public boolean onTouchEvent (MotionEvent motionEvent) {
        ...
        switch (motionEvent.getAction() & MotionEvent.ACTION_MASK) {
             ...
             * We will use more complicated and robust touch handling
             * in later projects.
             * */
